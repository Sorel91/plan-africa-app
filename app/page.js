          ...
          <div>
            ...
            <div className="mt-10 hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:block">
              ...
              <p className="mt-2 text-sm text-slate-600">
                Essentiel pour démarrer rapidement, Confort pour un projet plus abouti,
                Premium pour un accompagnement plus poussé.
              </p>
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                ...
                <div className="rounded-full bg-emerald-100 px-3 py-2 text-sm font-medium text-emerald-700">
                  Confort recommandé
                </div>
                <div className="rounded-full bg-slate-100 px-3 py-2 text-sm text-slate-700">
                  Premium prioritaire
