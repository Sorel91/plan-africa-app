        ...
        <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur">
          <div className="mx-auto max-w-6xl px-6 py-4 lg:px-8">
            ...
            <details className="mt-3 md:hidden">
              <summary className="flex cursor-pointer list-none items-center justify-between rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-900 shadow-sm">
                <span>Menu</span>
              ...
              <nav className="mt-2 flex flex-col gap-2 rounded-2xl border border-slate-200 bg-white p-2 shadow-sm">
                <a
                  href="/prix"
